      ...
      <div className="wrap">
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1 space-y-16">
            ...
            {/* Amenities Grid */}
            <section>
              <h2 className="text-2xl text-white font-light mb-6 border-b border-[#27272A] pb-4">Room Amenities</h2>
            ...
            {/* Gallery */}
            <section>
              <h2 className="text-2xl text-white font-light mb-6 border-b border-[#27272A] pb-4">Gallery</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {room.gallery.slice(1).map((img, idx) => (
                  <div key={idx} className="relative aspect-[4/3] bg-[#18181B] overflow-hidden group">
                    <Image
                      src={img}
          ...
          <div className="w-full lg:w-[400px] shrink-0 sticky top-32">
            <div className="bg-[#18181B] border border-[#27272A] p-8 shadow-subtle">
