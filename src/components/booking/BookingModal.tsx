      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-x-4 top-4 bottom-4 md:inset-x-auto md:left-1/2 md:-translate-x-1/2 md:top-6 md:bottom-6 md:w-full md:max-w-2xl lg:max-w-3xl z-50 bg-[#18181B] shadow-hover border border-[#27272A] flex flex-col overflow-hidden"
          >
            {/* Header */}
            <div className="flex items-center justify-between px-8 py-6 border-b border-[#27272A] shrink-0 bg-[#09090B]">
                ...
                <div key={step.number} className="flex-1">
                  <div
                    className={`h-0.5 transition-all duration-500 ${
                      step.number <= currentStep ? "bg-white" : "bg-[#27272A]"
                    }`}
                  />
                  <p
            ...
            {/* Footer */}
            {currentStep < 4 && (
              <div className="px-8 py-5 border-t border-[#27272A] bg-[#09090B] shrink-0">
