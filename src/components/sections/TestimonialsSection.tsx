...
const reviews = [
  { name: "Arjun Sharma",  from: "Mumbai, India",     rating: 5, room: "Deluxe Room",   date: "April 2025",    init: "AS",
    text: "An exceptional airport hotel experience. The rooms are impeccably designed, the service is warm yet professional, and the location couldn't be more convenient. Hotel Oak has redefined what airport hotels can be." },
  ...
  { name: "Michael Chen",  from: "Singapore",         rating: 5, room: "Superior Suite", date: "February 2025", init: "MC",
    text: "As a frequent business traveller, I demand quality and consistency. Hotel Oak delivered on both fronts flawlessly. The staff anticipated every need, the WiFi was excellent, and the dining was a pleasant surprise." },
